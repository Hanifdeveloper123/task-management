            ...
            <section>
                <div class="w-full">
                    ...
                    <VInput placeholder="Masukkan Nama Anda" label="Name" :required="true" v-model="form.name"
                        :errorMessage="formError.name" @update:modelValue="formError.name = ''" class="lg:w-1/2 sm:w-auto"/>

                    <VInput placeholder="Masukkan Email Anda" label="Email" :required="true" v-model="form.email"
                        :errorMessage="formError.email" @update:modelValue="formError.email = ''" class="lg:w-1/2 sm:w-auto"/>

                    <VInput placeholder="Masukkan Password Anda" label="Password" :required="true" v-model="form.password"
                        :errorMessage="formError.password" @update:modelValue="formError.password = ''" class="lg:w-1/2 sm:w-auto"/>
                </div>
            </section>
